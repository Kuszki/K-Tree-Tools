...
#ifndef REMOVEJOBWIDGET_HPP
#define REMOVEJOBWIDGET_HPP
...
namespace Ui {	class RemovejobWidget; }

class RemovejobWidget : public AbstractWidget
{
	...
	private:
		...
		Ui::RemovejobWidget *ui;

	public:

		explicit RemovejobWidget(QWidget *parent = nullptr,
							const QVariantMap& data = QVariantMap());
		virtual ~RemovejobWidget(void) override;
