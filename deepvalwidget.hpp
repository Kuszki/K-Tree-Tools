...
#ifndef DEEPVALWIDGET_HPP
#define DEEPVALWIDGET_HPP
...
namespace Ui {	class DeepvalWidget; }

class DeepvalWidget : public AbstractWidget
{
	...
	public:
		...
		explicit DeepvalWidget(QWidget *parent = nullptr,
						   const QVariantMap& data = QVariantMap());
		virtual ~DeepvalWidget(void) override;
