...
#ifndef EMPTYRAPWIDGET_HPP
#define EMPTYRAPWIDGET_HPP
...
namespace Ui { class EmptyrapWidget; }

class EmptyrapWidget : public AbstractWidget
{
	...
	private:
		...
		Ui::EmptyrapWidget *ui;

	public:

		explicit EmptyrapWidget(QWidget *parent = nullptr,
						    const QVariantMap& data = QVariantMap());
		virtual ~EmptyrapWidget(void) override;
