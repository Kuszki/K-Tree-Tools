...
#ifndef EMPTYVALWIDGET_HPP
#define EMPTYVALWIDGET_HPP
...
namespace Ui {	class EmptyvalWidget; }

class EmptyvalWidget : public AbstractWidget
{
	...
	private:
		...
		Ui::EmptyvalWidget *ui;

	public:

		explicit EmptyvalWidget(QWidget *parent = nullptr,
						    const QVariantMap& data = QVariantMap());
		virtual ~EmptyvalWidget(void) override;
