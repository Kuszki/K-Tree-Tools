...
#ifndef DEEPRAPWIDGET_HPP
#define DEEPRAPWIDGET_HPP
...
namespace Ui {	class DeeprapWidget; }

class DeeprapWidget : public AbstractWidget
{
	...
	public:
		...
		explicit DeeprapWidget(QWidget *parent = nullptr,
						   const QVariantMap& data = QVariantMap());
		virtual ~DeeprapWidget(void) override;
