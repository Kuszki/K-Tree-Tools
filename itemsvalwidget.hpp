...
#ifndef ITEMSVALWIDGET_HPP
#define ITEMSVALWIDGET_HPP
...
namespace Ui {	class ItemsvalWidget; }

class ItemsvalWidget : public AbstractWidget
{
	...
	private:
		...
		Ui::ItemsvalWidget *ui;

	public:

		explicit ItemsvalWidget(QWidget *parent = nullptr,
						    const QVariantMap& data = QVariantMap());
		virtual ~ItemsvalWidget(void) override;
